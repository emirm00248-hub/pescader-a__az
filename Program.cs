...
{
    // PLATILLOS
    new Product("1", "Pescado Empanizado (Orden)", "Incluye pescado empanizado acompañado de arroz, frijol, tortillas y guarnición.", 120m, "Platillos", "Orden", true, true, true, true, 100m, new List<string> { "Filete de pescado", "Pan molido", "Especias", "Arroz", "Frijoles", "Tortillas" }, "15 min", "Mérida, Yucatán"),
    ...
    new Product("3", "Camarón Empanizado (Orden)", "Incluye camarones empanizados de primera, arroz, frijol, tortillas y guarnición.", 170m, "Platillos", "Orden", true, true, true, true, 150m, new List<string> { "Camarón fresco", "Empanizador", "Arroz", "Frijoles", "Tortillas", "Ensalada" }, "18 min", "Campeche, México"),
    ...
    new Product("6", "Cazón Frito (Orden)", "Orden de cazón frito tradicional. Disponible únicamente miércoles y viernes.", 110m, "Platillos", "Orden", true, true, true, true, 95m, new List<string> { "Cazón fresco", "Aceite vegetal", "Especias", "Acompañamientos" }, "20 min", "Golfo de México"),
